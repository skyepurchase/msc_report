...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{ }
    \end{subfigure}
    \caption{Result of running CAA \cite{caa} in the prompt pairs environment \Sref{sec:prompt-pairs} on GPT2 at layer 7. (a) The average activation of the target SAE features. (b) The average activation of SAE features that were not present in the positive or negative examples. (c) The semantic similarity of the generated token and the target token. In all cases the dashed line is the baseline for the model without steering.}
